...
public:
	...
	bImage(int width, int height, int type, COLORREF colour_from, COLORREF colour_to, bool interlaced, int bevelStyle, int bevelPosition)
	{
		...
		case B_MIRRORHORIZONTAL:
			...
			table_fn_mirror(xtab, width, false);
...
extern "C" void MakeGradient(HDC hDC, RECT rect, int type, COLORREF colour_from, COLORREF colour_to, bool interlaced, int bevelStyle, int bevelPosition, int bevelWidth, COLORREF borderColour, int borderWidth)
{
	...
	if (type >= 0)
	{
		...
		bImage bImg(w, h, type, colour_from, colour_to, interlaced, bevelStyle, bevelPosition);
...
{
	bImage bImg(width, height, type, colour_from, colour_to, interlaced, bevelStyle, bevelPosition);
