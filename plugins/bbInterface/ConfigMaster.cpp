...
int config_backup(char *filename)
{
	...
	MessageBox(NULL, temp, szAppName, MB_OK|MB_SYSTEMMODAL);

	if (!FileExists(bakfile) || IDYES == MessageBox(NULL,
...
{
	if (!stricmp(string, szTrue))
	{
		*valptr = true;
		return true;
	}
	else if (!stricmp(string, szFalse))
	{
		*valptr = false;
		return true;
	}
...
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityControl, szBActionCreate, ct->controltypename);
	return config_masterbroam;
}
char *config_get_control_create_named(controltype *ct, control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityControl, szBActionCreate, ct->controltypename, c->controlname);
	return config_masterbroam;
}
char *config_get_control_create_child(control *c_p, controltype *ct)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityControl, szBActionCreateChild, c_p->controlname, ct->controltypename);
	return config_masterbroam;
}
char *config_get_control_create_child_named(control *c_p, controltype *ct, control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s", szBBroam, szBEntityControl, szBActionCreateChild, c_p->controlname, ct->controltypename, c->controlname);
	return config_masterbroam;
}
char *config_get_control_delete(control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityControl, szBActionDelete, c->controlname);
	return config_masterbroam;
}
char *config_get_control_saveas(control *c, const char *filename)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityControl, szBActionSaveAs, c->controlname, filename);
	return config_masterbroam;
}
char *config_get_control_renamecontrol_s(control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityControl, szBActionRename, c->controlname);
	return config_masterbroam;
}
char *config_get_control_clone(control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityControl, "Clone", c->controlname);
	return config_masterbroam;
}

char *config_get_control_setagent_s(control *c, const char *action, const char *agenttype)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetAgent, c->controlname, action, agenttype);
	return config_masterbroam;
}
char *config_get_control_setagent_c(control *c, const char *action, const char *agenttype, const char *parameters)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s \"%s\"", szBBroam, szBEntityControl, szBActionSetAgent, c->controlname, action, agenttype, parameters);
	return config_masterbroam;
}
char *config_get_control_setagent_b(control *c, const char *action, const char *agenttype, const bool *parameters)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetAgent, c->controlname, action, agenttype, (*parameters ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_get_control_setagent_i(control *c, const char *action, const char *agenttype, const int *parameters)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s %d", szBBroam, szBEntityControl, szBActionSetAgent, c->controlname, action, agenttype, *parameters);
	return config_masterbroam;
}
char *config_get_control_setagent_d(control *c, const char *action, const char *agenttype, const double *parameters)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s %f", szBBroam, szBEntityControl, szBActionSetAgent, c->controlname, action, agenttype, *parameters);
	return config_masterbroam;
}

char *config_get_control_removeagent(control *c, const char *action)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityControl, szBActionRemoveAgent, c->controlname, action);
	return config_masterbroam;
}

char *config_get_control_setagentprop_s(control *c, const char *action, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->controlname, action, key);
	return config_masterbroam;
}
char *config_get_control_setagentprop_c(control *c, const char *action, const char *key, const char *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s \"%s\"", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->controlname, action, key, value);
	return config_masterbroam;
}
char *config_get_control_setagentprop_b(control *c, const char *action, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->controlname, action, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_get_control_setagentprop_i(control *c, const char *action, const char *key, const int *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s %d", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->controlname, action, key, *value);
	return config_masterbroam;
}
char *config_get_control_setagentprop_d(control *c, const char *action, const char *key, const double *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s %f", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->controlname, action, key, *value);
	return config_masterbroam;
}

char *config_get_control_setcontrolprop_s(control *c, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetControlProperty, c->controlname, key);
	return config_masterbroam;
}
char *config_get_control_setcontrolprop_c(control *c, const char *key, const char *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s \"%s\"", szBBroam, szBEntityControl, szBActionSetControlProperty, c->controlname, key, value);
	return config_masterbroam;
}
char *config_get_control_setcontrolprop_b(control *c, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetControlProperty, c->controlname, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_get_control_setcontrolprop_i(control *c, const char *key, const int *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %d", szBBroam, szBEntityControl, szBActionSetControlProperty, c->controlname, key, *value);
	return config_masterbroam;
}
char *config_get_control_setcontrolprop_d(control *c, const char *key, const double *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %f", szBBroam, szBEntityControl, szBActionSetControlProperty, c->controlname, key, *value);
	return config_masterbroam;
}

char *config_get_control_setwindowprop_s(control *c, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->controlname, key);
	return config_masterbroam;
}
char *config_get_control_setwindowprop_c(control *c, const char *key, const char *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s \"%s\"", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->controlname, key, value);
	return config_masterbroam;
}
char *config_get_control_setwindowprop_b(control *c, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->controlname, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_get_control_setwindowprop_i(control *c, const char *key, const int *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %d", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->controlname, key, *value);
	return config_masterbroam;
}
char *config_get_control_setwindowprop_d(control *c, const char *key, const double *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %f", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->controlname, key, *value);
	return config_masterbroam;
}

char *config_get_agent_setagentprop_s(const char *agenttype, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityAgent, szBActionSetAgentProperty, agenttype, key);
	return config_masterbroam;
}
char *config_get_agent_setagentprop_c(const char *agenttype, const char *key, const char *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s \"%s\"", szBBroam, szBEntityAgent, szBActionSetAgentProperty, agenttype, key, value);
	return config_masterbroam;
}
char *config_get_agent_setagentprop_b(const char *agenttype, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s", szBBroam, szBEntityAgent, szBActionSetAgentProperty, agenttype, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_get_agent_setagentprop_i(const char *agenttype, const char *key, const int *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %d", szBBroam, szBEntityAgent, szBActionSetAgentProperty, agenttype, key, *value);
	return config_masterbroam;
}
char *config_get_agent_setagentprop_d(const char *agenttype, const char *key, const double *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %f", szBBroam, szBEntityAgent, szBActionSetAgentProperty, agenttype, key, *value);
	return config_masterbroam;
}

char *config_get_control_setpluginprop_s(control *c, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetPluginProperty, c->controlname, key);
	return config_masterbroam;
}
char *config_get_control_setpluginprop_b(control *c, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s %s", szBBroam, szBEntityControl, szBActionSetPluginProperty, c->controlname, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}

char *config_get_plugin_setpluginprop_s(const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityPlugin, szBActionSetPluginProperty, key);
	return config_masterbroam;
}
char *config_get_plugin_setpluginprop_c(const char *key, const char *value)
{
	sprintf(config_masterbroam, "%s %s %s %s \"%s\"", szBBroam, szBEntityPlugin, szBActionSetPluginProperty, key, value ? value : "");
	return config_masterbroam;
}
char *config_get_plugin_setpluginprop_b(const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityPlugin, szBActionSetPluginProperty, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_get_plugin_setpluginprop_i(const char *key, const int *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %d", szBBroam, szBEntityPlugin, szBActionSetPluginProperty, key, *value);
	return config_masterbroam;
}
char *config_get_plugin_setpluginprop_d(const char *key, const double *value)
{
	sprintf(config_masterbroam, "%s %s %s %s %f", szBBroam, szBEntityPlugin, szBActionSetPluginProperty, key, *value);
	return config_masterbroam;
}

char *config_get_plugin_load_dialog()
{
	sprintf(config_masterbroam, "%s %s %s", szBBroam, szBEntityPlugin, szBActionLoad);
	return config_masterbroam;
}
char *config_get_plugin_load(const char *file)
{
	sprintf(config_masterbroam, "%s %s %s \"%s\"", szBBroam, szBEntityPlugin, szBActionLoad, file);
	return config_masterbroam;
}
char *config_get_plugin_save()
{
	sprintf(config_masterbroam, "%s %s %s", szBBroam, szBEntityPlugin, szBActionSave);
	return config_masterbroam;
}
char *config_get_plugin_saveas()
{
	sprintf(config_masterbroam, "%s %s %s", szBBroam, szBEntityPlugin, szBActionSaveAs);
	return config_masterbroam;
}
char *config_get_plugin_revert()
{
	sprintf(config_masterbroam, "%s %s %s", szBBroam, szBEntityPlugin, szBActionRevert);
	return config_masterbroam;
}
char *config_get_plugin_edit()
{
	sprintf(config_masterbroam, "%s %s %s", szBBroam, szBEntityPlugin, szBActionEdit);
	return config_masterbroam;
}

char *config_get_module_create()
{
	sprintf(config_masterbroam, "%s %s %s", szBBroam, szBEntityModule, szBActionCreate);
	return config_masterbroam;
}
char *config_get_module_load_dialog()
{
	sprintf(config_masterbroam, "%s %s %s", szBBroam, szBEntityModule, szBActionLoad);
	return config_masterbroam;
}
char *config_get_module_load(module *m)
{
	sprintf(config_masterbroam, "%s %s %s \"%s\"", szBBroam, szBEntityModule, szBActionLoad, m->filepath);
	return config_masterbroam;
}
char *config_get_module_toggle(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityModule, szBActionToggle, m->name);
	return config_masterbroam;
}
char *config_get_module_edit(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityModule, szBActionEdit, m->name);
	return config_masterbroam;
}
char *config_get_module_setdefault(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityModule, szBActionSetDefault, m == &globalmodule ? "*global*" : m->name);
	return config_masterbroam;
}

char *config_get_module_setauthor_s(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityModule, szBActionSetModuleProperty, m->name, "Author");
	return config_masterbroam;
}
char *config_get_module_setcomments_s(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityModule, szBActionSetModuleProperty, m->name, "Comments");
	return config_masterbroam;
}
char *config_get_module_rename_s(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityModule, szBActionRename, m->name);
	return config_masterbroam;
}
char *config_get_module_onload_s(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityModule, szBActionOnLoad, m->name, m->actions[MODULE_ACTION_ONLOAD] ? m->actions[MODULE_ACTION_ONLOAD] : "");
	return config_masterbroam;
}
char *config_get_module_onunload_s(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityModule, szBActionOnUnload, m->name, m->actions[MODULE_ACTION_ONUNLOAD] ? m->actions[MODULE_ACTION_ONUNLOAD] : "");
	return config_masterbroam;
}
...
{
	sprintf(config_masterbroam, "%s %s %s %s %s", szBBroam, szBEntityControl, szBActionAssignToModule, c->controlname, m->name);
	return config_masterbroam;
}
char *config_get_control_detachfrommodule(control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s", szBBroam, szBEntityControl, szBActionDetachFromModule, c->controlname);
	return config_masterbroam;
}
char *config_get_module_onload(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s \"%s\"", szBBroam, szBEntityModule, szBActionOnLoad, m->name, m->actions[MODULE_ACTION_ONLOAD] ? m->actions[MODULE_ACTION_ONLOAD] : "");
	return config_masterbroam;
}
char *config_get_module_onunload(module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s \"%s\"", szBBroam, szBEntityModule, szBActionOnUnload, m->name, m->actions[MODULE_ACTION_ONUNLOAD] ? m->actions[MODULE_ACTION_ONUNLOAD] : "");
	return config_masterbroam;
}
char *config_get_plugin_onload()
{
	sprintf(config_masterbroam, "%s %s %s \"%s\"", szBBroam, szBEntityPlugin, szBActionOnLoad, globalmodule.actions[MODULE_ACTION_ONLOAD] ? globalmodule.actions[MODULE_ACTION_ONLOAD] : "");
	return config_masterbroam;
}
char *config_get_plugin_onunload()
{
	sprintf(config_masterbroam, "%s %s %s \"%s\"", szBBroam, szBEntityPlugin, szBActionOnUnload, globalmodule.actions[MODULE_ACTION_ONUNLOAD] ? globalmodule.actions[MODULE_ACTION_ONUNLOAD] : "");
	return config_masterbroam;
}

char *config_get_variable_set(listnode *ln)
{
	sprintf(config_masterbroam, "%s %s %s \"%s\"", szBBroam, szBEntityVarset, ln->key, (char *)ln->value);
	return config_masterbroam;
}
char *config_get_variable_set_static(listnode *ln)
{
	sprintf(config_masterbroam, "%s %s %s %s \"%s\"", szBBroam, szBEntityVarset, "Static", ln->key, (char *)ln->value);
	return config_masterbroam;
}
...
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s", szBBroam, szBEntityControl, szBActionCreateChild, c_p->moduleptr->name, c_p->controlname, ct->controltypename);
	return config_masterbroam;
}
char *config_getfull_control_create_child_named(control *c_p, controltype *ct, control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s", szBBroam, szBEntityControl, szBActionCreateChild, c_p->moduleptr->name, c_p->controlname, ct->controltypename, c->controlname);
	return config_masterbroam;
}
char *config_getfull_control_delete(control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s", szBBroam, szBEntityControl, szBActionDelete, c->moduleptr->name, c->controlname);
	return config_masterbroam;
}
char *config_getfull_control_saveas(control *c, const char *filename)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s", szBBroam, szBEntityControl, szBActionSaveAs, c->moduleptr->name, c->controlname, filename);
	return config_masterbroam;
}
char *config_getfull_control_renamecontrol_s(control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s", szBBroam, szBEntityControl, szBActionRename, c->moduleptr->name, c->controlname);
	return config_masterbroam;
}
char *config_getfull_control_clone(control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s", szBBroam, szBEntityControl, "Clone", c->moduleptr->name, c->controlname);
	return config_masterbroam;
}

char *config_getfull_control_setagent_s(control *c, const char *action, const char *agenttype)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s", szBBroam, szBEntityControl, szBActionSetAgent, c->moduleptr->name, c->controlname, action, agenttype);
	return config_masterbroam;
}
char *config_getfull_control_setagent_c(control *c, const char *action, const char *agenttype, const char *parameters)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s \"%s\"", szBBroam, szBEntityControl, szBActionSetAgent, c->moduleptr->name, c->controlname, action, agenttype, parameters);
	return config_masterbroam;
}
char *config_getfull_control_setagent_b(control *c, const char *action, const char *agenttype, const bool *parameters)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s %s", szBBroam, szBEntityControl, szBActionSetAgent, c->moduleptr->name, c->controlname, action, agenttype, (*parameters ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_getfull_control_setagent_i(control *c, const char *action, const char *agenttype, const int *parameters)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s %d", szBBroam, szBEntityControl, szBActionSetAgent, c->moduleptr->name, c->controlname, action, agenttype, *parameters);
	return config_masterbroam;
}
char *config_getfull_control_setagent_d(control *c, const char *action, const char *agenttype, const double *parameters)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s %f", szBBroam, szBEntityControl, szBActionSetAgent, c->moduleptr->name, c->controlname, action, agenttype, *parameters);
	return config_masterbroam;
}

char *config_getfull_control_removeagent(control *c, const char *action)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s", szBBroam, szBEntityControl, szBActionRemoveAgent, c->moduleptr->name, c->controlname, action);
	return config_masterbroam;
}

char *config_getfull_control_setagentprop_s(control *c, const char *action, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->moduleptr->name, c->controlname, action, key);
	return config_masterbroam;
}
char *config_getfull_control_setagentprop_c(control *c, const char *action, const char *key, const char *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s \"%s\"", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->moduleptr->name, c->controlname, action, key, value);
	return config_masterbroam;
}
char *config_getfull_control_setagentprop_b(control *c, const char *action, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s %s", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->moduleptr->name, c->controlname, action, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_getfull_control_setagentprop_i(control *c, const char *action, const char *key, const int *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s %d", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->moduleptr->name, c->controlname, action, key, *value);
	return config_masterbroam;
}
char *config_getfull_control_setagentprop_d(control *c, const char *action, const char *key, const double *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s %f", szBBroam, szBEntityControl, szBActionSetAgentProperty, c->moduleptr->name, c->controlname, action, key, *value);
	return config_masterbroam;
}

char *config_getfull_control_setcontrolprop_s(control *c, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s", szBBroam, szBEntityControl, szBActionSetControlProperty, c->moduleptr->name, c->controlname, key);
	return config_masterbroam;
}
char *config_getfull_control_setcontrolprop_c(control *c, const char *key, const char *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s \"%s\"", szBBroam, szBEntityControl, szBActionSetControlProperty, c->moduleptr->name, c->controlname, key, value);
	return config_masterbroam;
}
char *config_getfull_control_setcontrolprop_b(control *c, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s", szBBroam, szBEntityControl, szBActionSetControlProperty, c->moduleptr->name, c->controlname, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_getfull_control_setcontrolprop_i(control *c, const char *key, const int *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %d", szBBroam, szBEntityControl, szBActionSetControlProperty, c->moduleptr->name, c->controlname, key, *value);
	return config_masterbroam;
}
char *config_getfull_control_setcontrolprop_d(control *c, const char *key, const double *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %f", szBBroam, szBEntityControl, szBActionSetControlProperty, c->moduleptr->name, c->controlname, key, *value);
	return config_masterbroam;
}

char *config_getfull_control_setwindowprop_s(control *c, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->moduleptr->name, c->controlname, key);
	return config_masterbroam;
}
char *config_getfull_control_setwindowprop_c(control *c, const char *key, const char *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s \"%s\"", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->moduleptr->name, c->controlname, key, value);
	return config_masterbroam;
}
char *config_getfull_control_setwindowprop_b(control *c, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->moduleptr->name, c->controlname, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}
char *config_getfull_control_setwindowprop_i(control *c, const char *key, const int *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %d", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->moduleptr->name, c->controlname, key, *value);
	return config_masterbroam;
}
char *config_getfull_control_setwindowprop_d(control *c, const char *key, const double *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %f", szBBroam, szBEntityControl, szBActionSetWindowProperty, c->moduleptr->name, c->controlname, key, *value);
	return config_masterbroam;
}

char *config_getfull_control_setpluginprop_s(control *c, const char *key)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s", szBBroam, szBEntityControl, szBActionSetPluginProperty, c->moduleptr->name, c->controlname, key);
	return config_masterbroam;
}
char *config_getfull_control_setpluginprop_b(control *c, const char *key, const bool *value)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s %s", szBBroam, szBEntityControl, szBActionSetPluginProperty, c->moduleptr->name, c->controlname, key, (*value ? szTrue : szFalse));
	return config_masterbroam;
}

char *config_getfull_control_assigntomodule(control *c, module *m)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s %s", szBBroam, szBEntityControl, szBActionAssignToModule, c->moduleptr->name, c->controlname, m->name);
	return config_masterbroam;
}
char *config_getfull_control_detachfrommodule(control *c)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s", szBBroam, szBEntityControl, szBActionDetachFromModule, c->moduleptr->name, c->controlname);
	return config_masterbroam;
}

char *config_getfull_variable_set_static(module *m, listnode *ln)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s \"%s\"", szBBroam, szBEntityVarset, "Static", m->name, ln->key, (char *)ln->value);
	return config_masterbroam;
}
char *config_getfull_variable_set_static_s(module *m, listnode *ln)
{
	sprintf(config_masterbroam, "%s %s %s %s:%s", szBBroam, szBEntityVarset, "Static", m->name, ln->key);
	return config_masterbroam;
}
