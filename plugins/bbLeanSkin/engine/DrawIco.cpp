...
void perform_satnhue(BYTE *pixels, int size, int saturationValue, int hueIntensity)
{
	unsigned sat = (unsigned char )saturationValue;
	unsigned hue = (unsigned char )hueIntensity;
	unsigned i_sat = 256 - sat;
	unsigned i_hue = 256 - hue;
...
void drawIco (int px, int py, int size, HICON IconHop, HDC hDC, bool f, int saturationValue, int hueIntensity)
{
